...
public class EasyMatch extends AMatch {
    ...
    private static WaveComposition firstWaveCar = new WaveComposition(EnemyType.CAR, 1, 3);
    private static WaveComposition secondWaveTank = new WaveComposition(EnemyType.TANK, 1, 3);
    private static WaveComposition thirdWaveCar = new WaveComposition(EnemyType.CAR, 2, 5);
    private static WaveComposition fourthWaveTank = new WaveComposition(EnemyType.TANK, 2, 6);
    private static WaveComposition fifthWavePlane = new WaveComposition(EnemyType.PLANE, 1, 6);
    private static WaveComposition w6_Tank = new WaveComposition(EnemyType.TANK, 2, 8);
    private static WaveComposition w7_Car = new WaveComposition(EnemyType.CAR, 3, 3);
    private static WaveComposition w7_Tank = new WaveComposition(EnemyType.TANK, 3, 4);
    private static WaveComposition w8_Tank = new WaveComposition(EnemyType.TANK, 3, 9);
    private static WaveComposition w9_Tank = new WaveComposition(EnemyType.TANK, 3, 8);
    private static WaveComposition w9_Car = new WaveComposition(EnemyType.CAR, 3, 6);
    private static WaveComposition w10_Tank = new WaveComposition(EnemyType.TANK, 3, 3);
    private static WaveComposition w10_TankBoss = new WaveComposition(EnemyType.BOSS_TANK, 2, 1);
    private static WaveComposition w10_Car = new WaveComposition(EnemyType.CAR, 3, 3);
    private static WaveComposition w11_Tank = new WaveComposition(EnemyType.TANK, 3, 5);
    private static WaveComposition w11_Car = new WaveComposition(EnemyType.CAR, 3, 5);
    private static WaveComposition w11_Plane = new WaveComposition(EnemyType.PLANE, 3, 5);
    private static WaveComposition w12_Tank = new WaveComposition(EnemyType.TANK, 3, 13);
    private static WaveComposition w13_Car = new WaveComposition(EnemyType.CAR, 3, 14);
    private static WaveComposition w14_Tank = new WaveComposition(EnemyType.TANK, 3, 8);
    private static WaveComposition w14_Car = new WaveComposition(EnemyType.CAR, 3, 8);
    private static WaveComposition w15_Tank = new WaveComposition(EnemyType.TANK, 3, 4);
    private static WaveComposition w15_Car = new WaveComposition(EnemyType.CAR, 3, 4);
    private static WaveComposition w16_Plane = new WaveComposition(EnemyType.PLANE, 3, 15);
    private static WaveComposition w17_Tank = new WaveComposition(EnemyType.TANK, 4, 8);
    private static WaveComposition w17_Car = new WaveComposition(EnemyType.CAR, 4, 9);
    private static WaveComposition w18_Tank = new WaveComposition(EnemyType.TANK, 5, 5);
    private static WaveComposition w18_Car = new WaveComposition(EnemyType.CAR, 5, 5);
    private static WaveComposition w18_Plane = new WaveComposition(EnemyType.PLANE, 6, 5);
    private static WaveComposition w19_Tank = new WaveComposition(EnemyType.TANK, 6, 12);
    private static WaveComposition w20_TankBoss = new WaveComposition(EnemyType.BOSS_TANK, 5, 5);
    private static WaveComposition w21_Car = new WaveComposition(EnemyType.CAR, 7, 16);
    private static WaveComposition w22_Tank = new WaveComposition(EnemyType.TANK, 6, 10);
    private static WaveComposition w23_Plane = new WaveComposition(EnemyType.PLANE, 6, 10);
    private static WaveComposition w24_Tank = new WaveComposition(EnemyType.TANK, 8, 3);
    private static WaveComposition w24_Car = new WaveComposition(EnemyType.CAR, 8, 3);
    private static WaveComposition w24_Plane = new WaveComposition(EnemyType.PLANE, 8, 3);
    private static WaveComposition w25_TankBoss = new WaveComposition(EnemyType.BOSS_TANK, 6, 1);
    private static WaveComposition w26_Car = new WaveComposition(EnemyType.CAR, 10, 8);
    private static WaveComposition w27_Tank = new WaveComposition(EnemyType.TANK, 12, 6);
    private static WaveComposition w28_Tank = new WaveComposition(EnemyType.TANK, 10, 7);
    private static WaveComposition w28_Car = new WaveComposition(EnemyType.CAR, 10, 6);
    private static WaveComposition w29_Plane = new WaveComposition(EnemyType.PLANE, 12, 10);
    private static WaveComposition w30_TankBoss = new WaveComposition(EnemyType.BOSS_TANK, 4, 10);
